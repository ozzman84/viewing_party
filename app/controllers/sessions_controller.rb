class SessionsController < ApplicationController
  ...
  def create
    ...
    if user.present? && user.authenticate(params[:password])
      ...
      redirect_to dashboard_path, notice: 'The first rule of Viewing Party is: you do not talk about Viewing Party. The second rule of Viewing Party is: you DO NOT talk about Viewing Party!'
    else
